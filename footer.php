...
<body>
  ...
  <!-- Footer -->
  <footer class="bg-black text-white py-10 px-5 font-sans">
    <div class="max-w-6xl mx-auto flex flex-wrap justify-between gap-8">
      
      <!-- Column 1: About -->
      <div class="min-w-[200px] flex-1 mb-5">
        ...
        <ul class="space-y-2">
          <li>
            <a href="https://www.facebook.com/kpmim.official" target="_blank" class="inline-flex items-center gap-2 hover:opacity-80">
              <img src="facebook.png" alt="Facebook" class="w-6 h-6 object-contain" />
              <span>Facebook</span>
            </a>
          </li>
          <li>
            <a href="https://t.me/kpmimchannel" target="_blank" class="inline-flex items-center gap-2 hover:opacity-80">
              <img src="telegram.png" alt="Telegram" class="w-6 h-6 object-contain" />
    ...
    <!-- Location Section -->
    <div class="max-w-6xl mx-auto mt-10 pt-6">
    ...
    <!-- Copyright -->
    <div class="border-t border-gray-700 mt-8 pt-5 text-center text-sm text-gray-400">
